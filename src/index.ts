...
const targetvalues = [[[79, 208], [105, 204], [151, 189], [264, 159], [400, 119], [509, 95], [567, 91], [582, 95], [585, 111], [585, 136], [585, 164], [586, 184], [595, 198], [608, 201], [647, 201], [723, 188], [811, 169], [881, 154], [906, 146], [915, 142], [916, 144], [916, 147]]];
...
function render() {
    ...
    for (const targetStroke of targetvalues) {
        context.beginPath();
        curve.lineStart();
        for (const point of targetStroke) {
            curve.point(point[0], point[1]);
        }
